...
|                                     |
|  o Too expensive                    |
|  o Not using it enough              |
|  o Missing a feature I need         |
|  o Switching to another tool        |
|  o Technical issues                 |
|  o Temporary / don't need right now |
...
| Approaching plan limit | Upgrade nudge (not a wall — growth-paywall-cro handles this) |
...
- **market-emails**: For win-back email sequences after cancellation
- **growth-paywall-cro**: For in-app upgrade moments and trial expiration
- **growth-pricing**: For plan structure and annual discount strategy
- **growth-onboarding-cro**: For activation to prevent early churn
