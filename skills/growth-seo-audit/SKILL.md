...
- For AI search optimization (AEO, GEO, LLMO, AI Overviews), see the **growth-ai-seo** skill
...
- **growth-ai-seo**: For optimizing content for AI search engines (AEO, GEO, LLMO)
- **growth-programmatic-seo**: For building SEO pages at scale
- **growth-site-arch**: For page hierarchy, navigation design, and URL structure
- **growth-schema**: For implementing structured data
- **growth-page-cro**: For optimizing pages for conversion (not just ranking)
