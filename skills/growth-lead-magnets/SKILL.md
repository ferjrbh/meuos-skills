...
| ROI calculator | "Calculate Your Savings" (-> see **growth-free-tool**) |
...
**For form optimization**: See **growth-form-cro** skill
**For popup implementation**: See **growth-popup-cro** skill
...
**For landing page optimization**: See **growth-page-cro** skill
...
- **See growth-popup-cro** for implementation
...
- **See market-social** for social strategy
...
- **See market-ads** for campaign strategy
...
- **growth-free-tool**: For interactive tools as lead magnets (calculators, graders, quizzes)
- **market-copy**: For writing the lead magnet content itself
- **market-emails**: For nurture sequences after lead capture
- **growth-page-cro**: For optimizing lead magnet landing pages
- **growth-popup-cro**: For popup-based lead capture
- **growth-form-cro**: For optimizing capture forms
- **market-copy**: For content planning and topic selection
